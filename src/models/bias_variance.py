...
if __name__ == "__main__":
    """
    Función principal para análisis de sesgo-varianza
    """
    ...
    plt_complexity = plot_complexity_analysis(
    ...
    plt_complexity.savefig(FIGURES_DIR / "complexity_analysis.png", dpi=300, bbox_inches="tight")
